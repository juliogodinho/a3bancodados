...
class Relatorio:
    ...
    def get_relatorio_holerite(self):
        ...
        query_result = mongo.db["holerite"].find({}, 
                                                 {"codigo": 1, 
                                                  "cpf": 1,
                                                  "cnpj": 1,
                                                  "salariobruto": 1,
        ...
        df_holerite = pd.DataFrame(list(query_result))
        # Fecha a conexão com o Mongo
        mongo.close()
        # Exibe o resultado
        print(df_holerite)        
    ...
    def get_relatorio_empresa(self):
        ...
        mongo.connect()
        # Recupera os dados transformando em um DataFrame
        query_result = mongo.db["empresa"].find({}, 
                                                     {"cnpj": 1, 
                                                      "razaosocial": 1, 
                                                      "nomefantasia": 1, 
                                                      "_id": 0
                                                     }).sort("nomefantasia", ASCENDING)
        df_empresa = pd.DataFrame(list(query_result))
        # Fecha a conexão com o mongo
        mongo.close()
        # Exibe o resultado
        print(df_empresa)        
