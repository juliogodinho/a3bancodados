...
class Controller_Funcionario:
    ...
    def verifica_existencia_holerite_cpf(self, cpf:str=None, external: bool = False) -> bool:
        ...
        # Recupera os dados do novo cliente criado transformando em um DataFrame
        df_holerite = pd.DataFrame(self.mongo.db["holerite"].find({"cpf":f"{cpf}"}, {"codigo": 1, "cpf": 1, "cnpj": 1, "salariobruto": 1, "fgts": 1, "irpf": 1, "salarioliquido": 1, "_id": 0}))
